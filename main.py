...
if (args.run_name == '..'):
    args.run_name = f"{args.model},{args.type},train_{args.no_vols},test_{args.test_vols},{args.RDNconfig},attn_{args.attention},growth{args.growth},loss_{args.loss},bs_{args.batch_size},tv{args.tv}"
else:
    args.run_name = f"{args.model},{args.type},train_{args.no_vols},test_{args.test_vols},{args.RDNconfig},attn_{args.attention},growth{args.growth},loss_{args.loss},bs_{args.batch_size},tv{args.tv},{args.run_name}"
print(args.run_name)
