...
if (args.run_name == '..'):
    args.run_name = f"{args.model},{args.attention},{args.encoder},growth{args.growth},loss_{args.loss},batch_size_{args.batch_size}"
else:
    args.run_name = f"{args.model},{args.attention},{args.encoder},growth_{args.growth},loss_{args.loss},batch_size_{args.batch_size},{args.run_name}"
print(args.run_name)
